...
let fetchTorrent = async (query, type = "series") => {
  ...
  let url = `${hostdata.host}/api/v2.0/indexers/all/results?apikey=${
    ...
    type == "series"
      ...
      ? "&Category%5B%5D=2040"
      : ""
  }&Category%5B%5D=2080&Category%5B%5D=2045&Category%5B%5D=2050&Category%5B%5D=2080&Category%5B%5D=5080&Category%5B%5D=5040&Tracker%5B%5D=torrentleech&cache=false`;
